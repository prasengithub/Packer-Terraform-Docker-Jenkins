    ...
    stages {
		...
		stage('Packer Build AMI') {
          steps {
            ...
            sh 'pwd'
            sh 'ls -al'
            sh 'cp /var/lib/jenkins/workspace/pipeline2/packer-terraform-jenkins-docker-master/*.* .'
            sh 'ls -al'
        ...
        stage('Push Image to Docker Hub') {
          steps {
           sh    'docker push prasengithub/Jenkinspipeline:${BUILD_NUMBER}'
           }
        }
        ...
        stage('Deploy to Docker Host') {
          steps {
            ...
            sh    'docker -H tcp://10.1.1.111:2375 run --rm -dit --name prodwebapp1 --hostname prodwebapp1 -p 8000:80 prasengithub/Jenkinspipeline:${BUILD_NUMBER}'
            }
        }
